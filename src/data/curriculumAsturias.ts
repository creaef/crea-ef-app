...
export const COMPETENCIAS_ESPECIFICAS_ASTURIAS_PRIMARIA: CompetenciaEspecifica[] = [
  { id: 'CE.EF.1', numero: 1, nombre: 'Competencia Específica 1', descripcion: 'Adoptar un estilo de vida activo y saludable, incorporando la práctica regular de actividad física lúdico-deportiva, el cuidado del cuerpo, la educación postural y la prevención de riesgos, valorando los beneficios para la salud integral.' },
  { id: 'CE.EF.2', numero: 2, nombre: 'Competencia Específica 2', descripcion: 'Adaptar los elementos del propio esquema corporal, las capacidades físicas, perceptivo-motrices y coordinativas, así como las habilidades motrices básicas y específicas, a situaciones motrices variadas de forma segura y eficaz.' },
  { id: 'CE.EF.3', numero: 3, nombre: 'Competencia Específica 3', descripcion: 'Desarrollar procesos de autorregulación emocional y habilidades sociales durante la práctica motriz, fomentando la inclusión, el respeto a la diversidad, la igualdad de género y el juego limpio para una convivencia pacífica.' },
  { id: 'CE.EF.4', numero: 4, nombre: 'Competencia Específica 4', descripcion: 'Valorar e integrar la cultura motriz tradicional y contemporánea, reconociendo y practicando manifestaciones del patrimonio lúdico asturiano (xuegos populares y tradicionales asturianos, bolos) y expresiones artístico-expresivas.' },
  { id: 'CE.EF.5', numero: 5, nombre: 'Competencia Específica 5', descripcion: 'Interactuar en el medio natural y urbano de manera autónoma, segura y ecosostenible a través de la práctica de actividades motrices, promoviendo el cuidado del entorno y la movilidad activa.' }
];
...
export const CRITERIOS_EVALUACION_ASTURIAS_PRIMARIA: CriterioEvaluacion[] = [
  ...
  { id: '1.3', codigo: 'EFI.1.3', ciclo: 'Primer Ciclo', competenciaId: 'CE.EF.1', descripcion: 'Aplicar normas básicas de seguridad y prevención de accidentes en los juegos escolares.' },
  { id: '2.1', codigo: 'EFI.2.1', ciclo: 'Primer Ciclo', competenciaId: 'CE.EF.2', descripcion: 'Desarrollar el esquema corporal, la dominancia lateral y el equilibrio estático y dinámico en juegos sencillos.' },
  { id: '2.2', codigo: 'EFI.2.2', ciclo: 'Primer Ciclo', competenciaId: 'CE.EF.2', descripcion: 'Aplicar habilidades motrices básicas (desplazamientos, saltos, giros y lanzamientos) en tareas lúdicas.' },
  { id: '2.3', codigo: 'EFI.2.3', ciclo: 'Primer Ciclo', competenciaId: 'CE.EF.2', descripcion: 'Experimentar el cuerpo como vehículo de expresión gestual, comunicación no verbal y juego dramático simple.' },
  { id: '3.1', codigo: 'EFI.3.1', ciclo: 'Primer Ciclo', competenciaId: 'CE.EF.3', descripcion: 'Aceptar y cumplir las reglas básicas de los juegos, colaborando activamente sin discriminación.' },
  { id: '3.2', codigo: 'EFI.3.2', ciclo: 'Primer Ciclo', competenciaId: 'CE.EF.3', descripcion: 'Expresar y regular emociones básicas asociadas al esfuerzo, la victoria o la derrota en situaciones lúdicas.' },
  { id: '4.1', codigo: 'EFI.4.1', ciclo: 'Primer Ciclo', competenciaId: 'CE.EF.4', descripcion: 'Conocer y participar en juegos tradicionales y populares del entorno asturiano y de otras culturas.' },
  ...
  // SEGUNDO CICLO
  { id: '1.1', codigo: 'EFI.1.1', ciclo: 'Segundo Ciclo', competenciaId: 'CE.EF.1', descripcion: 'Reconocer las respuestas fisiológicas inmediatas del cuerpo ante el esfuerzo físico continuado.' },
  { id: '1.2', codigo: 'EFI.1.2', ciclo: 'Segundo Ciclo', competenciaId: 'CE.EF.1', descripcion: 'Consolidar rutinas de calentamiento general, vuelta a la calma, hidratación y alimentación equilibrada.' },
  ...
  { id: '2.2', codigo: 'EFI.2.2', ciclo: 'Segundo Ciclo', competenciaId: 'CE.EF.2', descripcion: 'Regular el esfuerzo motriz adaptando el control postural, la orientación espacial y el ritmo a situaciones imprevistas.' },
  ...
  { id: '4.1', codigo: 'EFI.4.1', ciclo: 'Segundo Ciclo', competenciaId: 'CE.EF.4', descripcion: 'Identificar, practicar y valorar juegos tradicionales y deportes autóctonos asturianos (iniciación a modalidades de bolos asturianos y deportes tradicionales).' },
  { id: '4.2', codigo: 'EFI.4.2', ciclo: 'Segundo Ciclo', competenciaId: 'CE.EF.4', descripcion: 'Participar en bailes tradicionales asturianos y danzas colectivas mostrando adecuación rítmica y respeto patrimonial.' },
  ...
  { id: '4.1', codigo: 'EFI.4.1', ciclo: 'Tercer Ciclo', competenciaId: 'CE.EF.4', descripcion: 'Valorar el origen e importancia cultural de los juegos y modalidades de bolos asturianos (cuatreada, birle, batiente) como patrimonio inmaterial.' },
...
export const SABERES_BASICOS_ASTURIAS_PRIMARIA: SaberBasico[] = [
  ...
  { codigo: 'EFI.PRI.E.1', bloque: 'E', bloqueNombre: 'Manifestaciones de la cultura motriz', ciclo: 'Todos', descripcion: 'Xuegos populares y tradicionales asturianos; modalidades tradicionales de bolos asturianos (cuatreada, birle, batiente) y deportes tradicionales; expresión corporal, mimo, dramatización y acrosport; bailes y danzas tradicionales de Asturias y del mundo; análisis social del deporte.' },
  { codigo: 'EFI.PRI.F.1', bloque: 'F', bloqueNombre: 'Interacción eficiente y sostenible con el entorno', ciclo: 'Todos', descripcion: 'Técnicas de orientación espacial con planos y mapas; actividades de senderismo y montaña en el entorno natural asturiano; prevención de riesgos al aire libre; movilidad activa, desplazamientos sostenibles y cultura de residuo cero.' }
];
...
export const SABERES_BASICOS_ASTURIAS_ESO: SaberBasico[] = [
  ...
  { codigo: 'EFI.ESO.F.1', bloque: 'F', bloqueNombre: 'Interacción eficiente y sostenible con el entorno', ciclo: 'Todos', descripcion: 'Carreras de orientación en el medio natural y urbano; senderismo y cicloturismo (BTT); actividades acuáticas, de montaña y deslizamiento; escalada y cabuyería básica; normativa sobre espacios naturales protegidos, residuo cero y movilidad activa urbana.' }
];
